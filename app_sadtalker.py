                ...
                with gr.Tabs(elem_id="sadtalker_driven_audio"):
                    with gr.TabItem('Upload OR TTS'):
                        ...
                        if sys.platform != 'win32' and not in_webui:
                            from src.utils.text2speech import TTSTalker, TTS_OPENAI
                            # tts_talker = TTSTalker()
                            tts_talker = TTS_OPENAI()
                            with gr.Column(variant='panel'):
                                ...
                                tts.click(fn=tts_talker.test, inputs=[
                                          input_text], outputs=[driven_audio], show_progress=True)
...
if __name__ == "__main__":
    ...
    demo.launch(
        ...
        ssl_certfile="local_ssl/cert.pem",
        ssl_keyfile="local_ssl/key.pem",
        ssl_verify=False,
...
# nohup python -u app_sadtalker.py > app.log 2>&1 &

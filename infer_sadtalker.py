...
def main(args):
    ...
    # 生成动画视频
    video = animate_from_coeff.generate(
    ...
    video_path = os.path.join(save_dir, os.path.basename(video))
    shutil.move(video, save_dir)
    print(f'The generated video is saved at: {video_path}')
...
if __name__ == '__main__':
    ...
    # TODO 下载两个权重 checkpoints 和 gfpgan
    args.checkpoint_dir = "/data0/lizhong/models/sadtalker/checkpoints"
    # cp -r /data0/lizhong/models/sadtalker/gfpgan /data0/lizhong/SadTalker/gfpgan

    args.driven_audio = "/data0/lizhong/RealChatPaper/TTS/default.wav"
    args.source_image = "/data0/lizhong/SadTalker/doctor_11.jpg"
    # args.source_image = "/data0/lizhong/SadTalker/docker_2.jpg"
    # args.source_image = "/data0/lizhong/SadTalker/examples/source_image/art_0.png"
    # args.source_image = "/data0/lizhong/SadTalker/doctor_14.jpg"
    args.verbose = True
